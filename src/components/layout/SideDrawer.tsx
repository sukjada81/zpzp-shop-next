...
export default function SideDrawer({
    ...
    const itemsMenu: DrawerItemDef[] = useMemo(() => {
        ...
        const base: DrawerItemDef[] = [
            ...
            { href: href("orders"), label: "주문내역", Icon: Receipt },
            { href: href("coupons"), label: "내 쿠폰", Icon: Ticket },
            {
                href: href("cart"),
                label: "장바구니",
                Icon: ShoppingCart,
            ...
            { href: href("settings"), label: "내 정보 설정", Icon: Settings, disabled: false },
        ];
    ...
    function goLogin() {
        ...
        const returnTo =
            typeof window !== "undefined"
                ? new URL(homePath, window.location.origin).toString()
