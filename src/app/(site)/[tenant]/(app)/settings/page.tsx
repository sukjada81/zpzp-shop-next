...
export default function SettingsPage() {
    ...
    const helper = useMemo(() => {
        return {
            // DAD 잔재 정리 + 배송 전용 반영. 원본 문구는 재개/추적 대비 주석 보존:
            //   nickname: "디스카운트 올데이 오픈채팅방과 동일한 닉네임으로 입력해 주세요. 하단 버튼에서 확인할 수 있습니다."
            //   phone: "픽업일 알림톡 발송 시 필요합니다."
            //   recommender: "디스카운트 올데이를 추천해줬다면 추천인의 닉네임을 입력해주세요."
            nickname: "다른 이용자에게 표시될 닉네임을 입력해 주세요.",
            phone: "주문·배송 안내 알림톡 발송 시 필요합니다.",
            recommender: "줍줍링크를 추천해줬다면 추천인의 닉네임을 입력해주세요.",
        };
    }, []);
